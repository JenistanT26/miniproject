...
const FacultyLogin = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (username && password) {
      // Navigate to faculty dashboard with username as state
      ...
      <div className="row g-0 full-height">
        ...
        <div className="col-md-6 d-none d-md-block login-image-side">
          ...
          <div className="image-content">
            <h1 className="welcome-text">Welcome to <span className="highlight">Faculty Portal</span></h1>
            <p className="tagline">Inspiring minds, shaping futures</p>
            <div className="edu-card testimonial-card">
              <p>"The faculty portal has streamlined my teaching process and helps me better connect with my students."</p>
              <div className="testimonial-author">
                <span className="name">Dr. Anand Sharma</span>
                <span className="role">Professor, Department of Computer Science</span>
              </div>
            </div>
          </div>
          <img 
            src="https://img.freepik.com/free-photo/teacher-helping-student-lesson_23-2148892886.jpg?w=1060&t=st=1715608175~exp=1715608775~hmac=87fb0ebe6bfb9be34c4c54db97a1b6f1bdba77cc1aee2bcfa4d16a37b0b58b44" 
          ...
          <div className="login-form-container">
            <div className="text-center mb-3">
              <div className="logo-container">
                <div className="school-logo faculty">
                  <i className="fas fa-chalkboard-teacher"></i>
                </div>
              </div>
              <h2 className="edu-heading">Faculty Login</h2>
              <p className="text-muted small-text">Access your personalized faculty dashboard</p>
            </div>
            ...
            <div className="edu-card login-card">
              <div className="edu-card-body compact-form">
                <form onSubmit={handleSubmit}>
                  <div className="mb-3">
                    <label htmlFor="username" className="edu-form-label">Faculty ID</label>
                ...
                <div className="login-footer mt-3">
                  <p className="text-center mb-0">
                    <small className="small-text">Need help? Contact <a href="#" className="edu-text-primary">IT Support</a></small>
                  </p>
                </div>
              </div>
            </div>
